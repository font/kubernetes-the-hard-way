...
```
kubectl create -f https://raw.githubusercontent.com/font/kubernetes-the-hard-way/scripts/services/kubedns.yaml
```
...
```
kubectl create -f https://raw.githubusercontent.com/font/kubernetes-the-hard-way/scripts/deployments/kubedns.yaml
```
